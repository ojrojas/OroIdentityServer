...
internal sealed class IdentityRedirectService(IHttpContextAccessor context) : IIdentityRedirectService
{
    public const string StatusCookieName = "OroIdentityServer.StatusMessage";
