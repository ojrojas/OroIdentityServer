...
namespace OroIdentityServer.Services.OroIdentityServer.Infraestructure.Migrations
{
    ...
    public partial class AddRoleClaimUniqueIndex : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Ensure no duplicate role claims exist before creating unique index
...
WHERE r.""RoleId"" = dup.""RoleId"" AND r.""ClaimType"" = dup.""ClaimType"" AND r.""ClaimValue"" = dup.""ClaimValue"" AND r.""Id"" <> dup.keep_id;");
            ...
            // Create the unique index to guard against duplicate claims at DB level
            migrationBuilder.Sql(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_RoleClaims_RoleId_ClaimType_ClaimValue_Unique"" ON ""RoleClaims"" (""RoleId"", ""ClaimType"", ""ClaimValue"");");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentificationTypeId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_SecurityUsers_SecurityUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentificationTypes_Name",
                table: "IdentificationTypes",
                column: "Name",
                unique: true);
