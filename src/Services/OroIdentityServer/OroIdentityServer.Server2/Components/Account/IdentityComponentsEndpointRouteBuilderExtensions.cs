...
using OroIdentityServer.Server2.Components.Account.Pages;
using OroIdentityServer.Server2.Components.Account.Pages.Manage;
using OroIdentityServer.Server2.Data;
