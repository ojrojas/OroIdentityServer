...
public interface IRolesService
{
    ...
    Task<BaseResponseViewModel<RoleViewModel>> GetRoleByNameAsync(string roleName, CancellationToken cancellationToken);
    Task<BaseResponseViewModel<RoleViewModel>?> GetRoleByIdAsync(string roleId, CancellationToken cancellationToken);
